...
//  This header file contains a Templated versions of the Connection class.
//*******************************************************************
...
{
	//*******************************************************************
	// Connection structs contain pointers to parent, child and a pointer to the next connection node.
	// Each connection has a position in the list
	// 
	//*******************************************************************
...
public:
	...
	// Contains a list of Connection nodes.
